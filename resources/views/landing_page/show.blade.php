                ...
                @foreach ($cars as $car)
                    ...
                    <div class="col-md-6 wrap-about ftco-animate">
                        <div class="heading-section heading-section-white pl-md-5">
                            <span class="subheading">Detail {{ $car->name }}</span>
                            <h2 class="mb-4">{{ $car->police_number }}</h2>
                            <h2 class="mb-4">{{ $car->color }}</h2>
                            <h2 class="mb-4">{{ $car->price }}</h2>
                            <h2 class="mb-4">{{ $car->cc }}</h2>
                            <h2 class="mb-4">{{ $car->year }}</h2>

                            <p>Kondisi masih sempurna, second like new, ambil mobil dan tinggal pakai.</p>

                            <p><a href="{{ url('booking/create', $car->id) }}"
                                    class="btn btn-primary py-3 px-4">Booking Sekarang</a></p>
                        </div>
                    </div>
                @endforeach
            </div>
